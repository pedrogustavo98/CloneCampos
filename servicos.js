$(document).ready(function () {
    ...
    document.getElementById("adicionar-servico").addEventListener("click", function () {
        var carrosContainer = document.getElementById("campos-servicos");
        var carroCount = carrosContainer.getElementsByClassName("carro-servico").length + 1;

        var novoCarro = document.createElement("div");
        novoCarro.className = "mt-5 carro-servico";
